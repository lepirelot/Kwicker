...
async function getMessages(id_user, id_contact) {
    const request = {
        method: "GET",
        headers: {
            "Authorization": load_user.getToken()
    ...
    const response = await fetch(`/api/messages/getMessages/${id_user}/${id_contact}`, request);
    if (!response.ok) {
...
async function getSenders(id_recipient) {
    const request = {
        method: "GET",
        headers: {
            Authorization: load_user.getToken()
...
/**
 * get all conversations with id_sender and id_recipient in a table
 * @param id_user
 * @returns {number}
 */
...
/**
 * Get the profile image for the specified user
 * @param idUser the user's id
 * @return the profile image of the specified user
 */
async function getProfileImage(idUser) {
    const request = {
        method: "GET",
        headers: {
            "Authorization": load_user.getToken()
